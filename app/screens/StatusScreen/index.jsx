...
const MAX_VALUE = 5000; // Maximum value for the container
...
export default function SensorDataScreen() {
  ...
  // Calculate the fill percentage of the container based on the distance
  ...
  return (
    <LinearGradient colors={['#141e30', '#243b55']} style={styles.container}>
      ...
      <View style={styles.content}>
        <Animatable.View animation="bounceIn" duration={2000} style={styles.dataContainer}>
        <MaterialCommunityIcons name="speedometer" size={40} color="#fff" />
          <Text style={styles.dataValue}>{distance !== null ? `${distance} mm` : 'Loading...'}</Text>
        </Animatable.View>
